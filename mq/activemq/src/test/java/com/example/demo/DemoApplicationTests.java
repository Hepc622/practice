...
public class DemoApplicationTests {
	...
	public void producter(){
		...
		try {
           ...
           /*创建消息提供者*/
			producer = session.createProducer(message);
           /*创建消息，消息是基于session发送的所有有session来创建消息对象*/
			TextMessage textMessage = session.createTextMessage("Do you receiver that message?");

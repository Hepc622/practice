...
<body>
						...
						<c:forEach var="cons" items="${requestScope.cons }">
							<ul>
								<li id="${cons.context_id }" class="clickEvent"
									...
									class="intosingle"
									href="${pageContext.request.contextPath}/${nav.navigation_url }/single?id=${cons.context_id }">
	...
	<!-- 添加项目页面 -->
	<div class="theme-popover-add-project">
		...
		<div class="theme-popbod dform">
			<form class="theme-signin" name="loginform"
				action="${pageContext.request.contextPath}/upload/project?id=${title.title_id }"
				method="post">
				<img class="show-img-project" id="showImg" src="">
				<ol>
					<li><strong>标题图片：</strong><input class="ipt" type="file"
						name="file" size="20" /></li>
					<li><strong>项目标题：</strong><input class="ipt" type="text"
